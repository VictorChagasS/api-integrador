...
import IFindAllProvidersDTO from '@modules/appointments/dtos/IFindAllInMonthFromProviderDTO'
...
class AppointmentsRepository  implements IAppointmentsRepository {
    ...
    public async findAllInMonthFromProvider({provider_id,month, year}:IFindAllProvidersDTO): Promise<Appointment[]> {
    ...
    public async findAllInDayFromUser({user_id,month, year,day}:IFindAllInDayFromUserDTO): Promise<Appointment[]> {
        const appointments = this.appointments.filter(appointment => {
            return(

...
var ForgetPasswordController_1 = __importDefault(require("../controllers/ForgetPasswordController"));
...
var forgetPasswordController = new ForgetPasswordController_1.default();
...
passwordRouter.post('/forgot', celebrate_1.celebrate((_a = {},
    ...
    _a)), forgetPasswordController.create);

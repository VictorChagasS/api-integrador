...
describe('ResetPasswordService', function () {
    ...
    it('should not to able to reset password with non-existing token', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    it('should not to able to reset password with non-existing user', function () { return __awaiter(void 0, void 0, void 0, function () {
        var token;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fakeUserTokensRepository.generate('none_user')];
                case 1:
                    token = (_a.sent()).token;
    ...
    it('should not to able to reset password if passed more than 2 hours', function () { return __awaiter(void 0, void 0, void 0, function () {
        var user, token;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fakeUsersRepository.create({

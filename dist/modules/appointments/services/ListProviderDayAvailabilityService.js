...
var ListProviderDayAvailabilityService = /** @class */ (function () {
    ...
    ListProviderDayAvailabilityService.prototype.execute = function (_a) {
        var provider_id = _a.provider_id, year = _a.year, month = _a.month, day = _a.day;
        return __awaiter(this, void 0, void 0, function () {
            var appointments, hourStart, eachHourArray, currentDate, availability;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.appointmentsRepository.findAllInDayFromProvider({ provider_id: provider_id, year: year, month: month, day: day })];
                    case 1:

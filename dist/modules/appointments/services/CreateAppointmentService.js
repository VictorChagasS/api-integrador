                ...
                switch (_b.label) {
                    case 0:
                        ...
                        if (date_fns_1.getHours(appointmentDate) < 8 || date_fns_1.getHours(appointmentDate) > 17) {
                            throw new AppError_1.default('You can only create appointments between 8pm and 5pm');
                        }
                    ...
                    case 2:
                        appointment = _b.sent();
                        dateFormated = date_fns_1.format(appointmentDate, "dd/MM/yyyy 'Ã s' HH:mm'h'");

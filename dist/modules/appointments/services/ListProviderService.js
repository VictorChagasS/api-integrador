...
var ListProfileService = /** @class */ (function () {
    function ListProfileService(usersRepository, cacheProvider) {
        this.usersRepository = usersRepository;
        this.cacheProvider = cacheProvider;
    }
    ListProfileService.prototype.execute = function (_a) {
    ...
    ListProfileService = __decorate([
        tsyringe_1.injectable(),
        __param(0, tsyringe_1.inject('UsersRepository')),
        __param(1, tsyringe_1.inject('CacheProvider')),
        __metadata("design:paramtypes", [Object, Object])
    ], ListProfileService);
    return ListProfileService;
}());
exports.default = ListProfileService;

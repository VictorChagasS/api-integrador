...
var IAppointmentsRepository_1 = __importDefault(require("../IAppointmentsRepository"));
var ICreateAppointmentDTO_1 = __importDefault(require("../../dtos/ICreateAppointmentDTO"));
var IFindAllInMonthFromProviderDTO_1 = __importDefault(require("../../dtos/IFindAllInMonthFromProviderDTO"));
var Appointment_1 = __importDefault(require("../../infra/typeorm/entities/Appointment"));
var IFindAllInDayFromProviderDTO_1 = __importDefault(require("../../dtos/IFindAllInDayFromProviderDTO"));
var IFindAllInDayFromUserDTO_1 = __importDefault(require("../../dtos/IFindAllInDayFromUserDTO"));
var AppointmentsRepository = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                findAppointment = this.appointments.find(function (appointment) {
                    return date_fns_1.isEqual(appointment.date, date) && appointment.provider_id === provider_id;
                });
    ...
    AppointmentsRepository.prototype.findAllInDayFromUser = function (_a) {
        var user_id = _a.user_id, month = _a.month, year = _a.year, day = _a.day;
        return __awaiter(this, void 0, void 0, function () {
            var appointments;
            return __generator(this, function (_b) {
                appointments = this.appointments.filter(function (appointment) {

...
var UpdateProfileService = /** @class */ (function () {
    ...
    UpdateProfileService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var user, checkEmail, checkOldPassword, _b;
                ...
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        if (checkEmail && checkEmail.id !== user_id) {
                            throw new AppError_1.default('This email is already used by another user.');
                        }
                        if (password && !old_password) {
                            throw new AppError_1.default('You need to inform the current password.');
                        }
                    ...
                    case 3:
                        ...
                        if (!checkOldPassword) {
                            throw new AppError_1.default('Wrong current password.');
                        }
                        _b = user;

...
var IUsersRepository_1 = __importDefault(require("../IUsersRepository"));
var ICreateUserDTO_1 = __importDefault(require("../../dtos/ICreateUserDTO"));
var IFindAllProvidersDTO_1 = __importDefault(require("../../dtos/IFindAllProvidersDTO"));
...
var FakeUsersRepository = /** @class */ (function () {
    ...
    FakeUsersRepository.prototype.save = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            var findIndex;
            return __generator(this, function (_a) {
                findIndex = this.users.findIndex(function (findUser) { return user.id === user.id; });

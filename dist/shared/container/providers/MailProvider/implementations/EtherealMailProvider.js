...
var IMailProvider_1 = __importDefault(require("../models/IMailProvider"));
var nodemailer_1 = __importDefault(require("nodemailer"));
var ISendMailDTO_1 = __importDefault(require("../dtos/ISendMailDTO"));
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        _d = {
                            from: {
                                name: (from === null || from === void 0 ? void 0 : from.name) || 'Projeto',
                                address: (from === null || from === void 0 ? void 0 : from.email) || 'equipe@psicologo.com.br'
                            },
                            to: {
                                name: to.name,
                                address: to.email
